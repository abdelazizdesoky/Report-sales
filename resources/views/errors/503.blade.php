...
@section('message', 'نحن نقوم ببعض التحسينات حالياً. سنعود للعمل قريباً جداً، نشكر تفهمكم.')

@section('icon-bg', 'bg-slate-100 dark:bg-slate-800')
@section('icon-color', 'text-slate-600 dark:text-slate-400')
